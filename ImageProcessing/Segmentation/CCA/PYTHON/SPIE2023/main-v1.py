...
def get_training_augmentation(p_aug=1):
    ...
    Args:
        p_aug (float): Probability of applying the augmentation transforms. Defaults to 1.

    Returns:
        albumentations.Compose: Augmentation pipeline for training data.
    """
...
if __name__ == '__main__':
    ...
    for rr in range(0,8):
        for kk in range(0,5):
            ...
            DATA_DIR = '/home/francesco/PROJECT-OPTIC-NERVE/DATA/Folds-MachOut/f{}'.format(kk)
